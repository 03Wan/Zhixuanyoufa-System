...
前端采用 Vercel 托管，生产站点为 [zhixuanyoufa.myboverse.com](https://zhixuanyoufa.myboverse.com)。项目按前后端分离交付：
...
The frontend is hosted on Vercel and available at [zhixuanyoufa.myboverse.com](https://zhixuanyoufa.myboverse.com). The repository follows a separated frontend/backend delivery model:
